...
class OrbiterProject:
    ...
    add_connections(Iterable[OrbiterConnection] | OrbiterConnection)
    add_dags(Iterable[OrbiterDAG] | OrbiterDAG)
    add_env_vars(Iterable[OrbiterEnvVar] | OrbiterEnvVar)
    add_includes(Iterable[OrbiterInclude] | OrbiterInclude)
    add_pools(Iterable[OrbiterPool] | OrbiterPool)
    add_requirements(Iterable[OrbiterRequirement] | OrbiterRequirement)
    add_variables(Iterable[OrbiterVariable] | OrbiterVariable)
    """
